                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method = "POST" action = "addind.php">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" name = "name" pattern="[A-Za-z]+ [A-Za-z]+" title="Please enter a valid first name and last name" required>
                    </div>
                    <div class="form-group">
